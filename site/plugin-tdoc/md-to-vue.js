...
import { compileUsage } from '../../_tdesign-vue/src/_common/docs/compile';
...
function customRender({ source, file, md }) {
  ...
  if (pageData.isComponent && pageData.tdDocTabs.some((item) => item.tab === 'design')) {
    const designDocPath = path.resolve(__dirname, `../../_tdesign-vue/src/_common/docs/web/design/${componentName}.md`);
