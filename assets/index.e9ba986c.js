...
<\/script>
`,he=[{name:"autoWidth",type:"Boolean",defaultValue:!1,options:[]},{name:"disabled",type:"Boolean",defaultValue:!1,options:[]},{name:"readonly",type:"Boolean",defaultValue:!1,options:[]},{name:"largeNumber",type:"Boolean",defaultValue:!1,options:[]},{name:"size",type:"enum",defaultValue:"medium",options:[{label:"small",value:"small"},{label:"medium",value:"medium"},{label:"large",value:"large"}]},{name:"theme",type:"enum",defaultValue:"row",options:[{label:"column",value:"column"},{label:"row",value:"row"},{label:"normal",value:"normal"}]}],x={};x.setup=(e,a)=>{const n=i(he),t=[{label:"inputNumber",value:"inputNumber"}],u={inputNumber:'<t-input-number v-bind="configProps"/>'},r=i(`<template>${u[t[0].value].trim()}</template>`);function g($){r.value=`<template>${u[$].trim()}</template>`}return{configList:n,panelList:t,usageCode:r,onPanelChange:g}};var xe=function(){var e=this,a=e.$createElement,n=e._self._c||a;return n("base-usage",{attrs:{code:e.usageCode,"config-list":e.configList,"panel-list":e.panelList},on:{PanelChange:e.onPanelChange},scopedSlots:e._u([{key:"inputNumber",fn:function(t){var u=t.configProps;return[n("t-input-number",e._b({},"t-input-number",u,!1))]}}])})},ge=[];const h={};var $e=l(x,xe,ge,!1,ye,null,null,null);function ye(e){for(let a in h)this[a]=h[a]}const Ae=function(){return $e.exports}();export{we as D,Ae as U,Ce as a,Se as b,De as c,Pe as d,Ne as e,Ve as f,Ee as g,Fe as h,je as i,Me as j,Re as k,We as l,ze as m,Be as n,Ke as o,Le as p,Ue as q,qe as r,Je as s};
